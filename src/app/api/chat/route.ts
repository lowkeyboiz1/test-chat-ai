...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemMessage = {
      ...
      QUAN TRỌNG: Đảm bảo rằng JSON nằm giữa @@@<WEATHER_DATA> và </WEATHER_DATA>@@@, @@@<AGRI_PRICE_DATA> và </AGRI_PRICE_DATA>@@@, hoặc @@@<FARMING_TECHNIQUE> và </FARMING_TECHNIQUE>@@@. KHÔNG thêm bất kỳ nội dung nào khác trong các thẻ đó.`
    }
