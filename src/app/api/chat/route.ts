...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemMessage = {
      ...
      Với tất cả các câu hỏi không liên quan đến thời tiết, giá nông sản, hoặc kỹ thuật canh tác, hãy trả lời bằng văn bản thông thường.
      
      QUAN TRỌNG: Đảm bảo rằng JSON nằm giữa thẻ <WEATHER_DATA> và </WEATHER_DATA>, <AGRI_PRICE_DATA> và </AGRI_PRICE_DATA>, hoặc <FARMING_TECHNIQUE> và </FARMING_TECHNIQUE>. KHÔNG thêm bất kỳ nội dung nào khác trong các thẻ đó.`
    }
